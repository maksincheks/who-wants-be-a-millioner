...
class GameWindow(QMainWindow):
    def __init__(self,filename):
        ...
        self.movie = QMovie("win_gif.gif")  # Укажите путь к вашему гиф-файлу
...
"    color: rgb(255, 255, 255);")
        ...
        self.take_out_text = QLabel(self)
        self.take_out_text.setGeometry(650, 400, 600,50)
...
"}")
        ...
        self.fon_menu.setGeometry(QtCore.QRect(400, 0, 1520, 1080))
        self.fon_menu.setPixmap(QtGui.QPixmap("image/cat_menu.jpg"))
